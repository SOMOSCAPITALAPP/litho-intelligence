...
export const intentionPages: IntentionPage[] = [
  ...
  {
    slug: "energie",
    queryLabel: "pierre pour l'énergie",
    shortLabel: "Énergie",
    title: "Pierres pour l'énergie : retrouver un élan symbolique",
    seoTitle: "Quelle pierre pour l'énergie ? Cornaline, citrine et apatite bleue",
    seoDescription: "Pierres traditionnellement associées à l'élan, à la motivation et au passage à l'action dans les croyances de lithothérapie.",
    intro: "Quand l'élan manque, une pierre chaude ou lumineuse peut devenir un rappel concret : choisir une action simple et avancer avec douceur.",
    ...
    meditationStone: "Cornaline",
    meditationIntention: "élan personnel",
    giftAngle: "Pour encourager un nouveau départ, la cornaline ou l'apatite bleue portent une symbolique claire et positive.",
    solutionSteps: ["Choisir une pierre solaire ou colorée.", "La porter le matin.", "Associer le bracelet à une action réaliste dans la journée."],
    faq: [
      { question: "Quelle pierre est associée à l'énergie ?", answer: "La cornaline, la citrine et l'apatite bleue sont souvent associées à l'élan symbolique et à la motivation." },
      { question: "Comment porter une pierre d'énergie ?", answer: "Le bracelet est pratique pour garder l'intention visible pendant une journée active." },
      { question: "Ces pierres donnent-elles de l'énergie physiquement ?", answer: "Non. Elles sont présentées comme supports symboliques et ne remplacent jamais un avis professionnel." },
      { question: "Quelle pierre offrir pour encourager quelqu'un ?", answer: "La cornaline et l'œil de tigre sont des choix lisibles pour symboliser courage et action." }
    ]
  },
  {
    slug: "cadeau",
    queryLabel: "pierre naturelle à offrir",
    shortLabel: "Cadeau",
    title: "Quelle pierre offrir ? Guide cadeau par intention",
    seoTitle: "Quelle pierre naturelle offrir ? Idées cadeaux et bracelets recommandés",
    seoDescription: "Guide cadeau pour choisir une pierre naturelle selon une intention : amour, protection, calme, confiance ou énergie.",
    intro: "Offrir une pierre, c'est donner une intention visible : soutien, douceur, protection, courage ou gratitude.",
    emotionalPromise: "La valeur du cadeau vient du message symbolique qui l'accompagne et de la clarté de l'intention.",
    recommendedStoneSlugs: ["quartz-rose", "labradorite", "oeil-de-tigre", "howlite", "amethyste"],
    meditationStone: "Quartz rose",
    meditationIntention: "attention sincère",
    giftAngle: "Choisissez une pierre facile à comprendre et ajoutez une phrase courte pour expliquer votre intention.",
    solutionSteps: ["Choisir la relation.", "Choisir l'occasion.", "Associer une intention simple au bracelet."],
    faq: [
      { question: "Quelle pierre offrir à une femme ?", answer: "Le quartz rose, l'améthyste et la labradorite sont des choix populaires selon l'intention du cadeau." },
      { question: "Quelle pierre offrir à un homme ?", answer: "L'œil de tigre, la labradorite foncée et la tourmaline noire sont des options sobres et symboliques." },
      { question: "Quelle pierre offrir pour la protection ?", answer: "La labradorite et l'œil de tigre sont traditionnellement associés à la protection symbolique." },
  ...
  },
  {
    ...
    queryLabel: "pierre pour hypersensibilité",
    shortLabel: "Hypersensibilité",
    title: "Pierres pour l'hypersensibilité : protection douce et limites",
    seoTitle: "Pierre pour hypersensibilité : labradorite, quartz rose et howlite",
    seoDescription: "Pierres traditionnellement associées aux personnes sensibles : protection symbolique, douceur et recentrage.",
    intro: "Pour les personnes qui absorbent beaucoup, une pierre peut symboliser une limite douce et un retour à soi.",
    emotionalPromise: "L'objectif est d'accompagner un rituel personnel de protection symbolique, sans promesse médicale.",
    recommendedStoneSlugs: ["labradorite", "quartz-rose", "howlite", "tourmaline-noire", "amethyste"],
    meditationStone: "Labradorite",
    meditationIntention: "limites douces",
    giftAngle: "La labradorite est un cadeau très lisible pour une personne sensible aux ambiances.",
    solutionSteps: ["Choisir une pierre de protection douce.", "La porter lors des journées chargées.", "Respirer 2 minutes en formulant une limite simple."],
    faq: [
      { question: "Quelle pierre est associée à l'hypersensibilité ?", answer: "La labradorite est souvent associée à la protection symbolique des personnes sensibles." },
      { question: "Peut-on l'associer au quartz rose ?", answer: "Oui, cette association symbolise protection et douceur." },
      { question: "Quelle forme choisir ?", answer: "Un bracelet est pratique car il reste visible pendant la journée." },
      { question: "Est-ce une solution médicale ?", answer: "Non, il s'agit d'une pratique symbolique ou culturelle." }
    ]
  },
  {
    slug: "fatigue-emotionnelle",
    queryLabel: "pierre pour fatigue émotionnelle",
    shortLabel: "Fatigue émotionnelle",
    title: "Pierres pour la fatigue émotionnelle : douceur et récupération symbolique",
    seoTitle: "Pierre pour fatigue émotionnelle : labradorite, améthyste et quartz rose",
    seoDescription: "Guide symbolique des pierres associées à la fatigue émotionnelle, au recentrage et à la douceur intérieure.",
    intro: "Quand l'émotionnel est saturé, les pierres douces ou protectrices peuvent rappeler de ralentir et de revenir à l'essentiel.",
    ...
    meditationStone: "Améthyste",
    meditationIntention: "repos intérieur",
    giftAngle: "Pour soutenir quelqu'un avec délicatesse, le quartz rose ou l'améthyste sont faciles à offrir.",
    solutionSteps: ["Choisir une pierre douce.", "La garder près de soi dans un moment calme.", "Associer la pierre à une respiration lente."],
    faq: [
      { question: "Quelle pierre choisir en fatigue émotionnelle ?", answer: "La labradorite, l'améthyste et le quartz rose sont souvent associés au recentrage et à la douceur." },
      ...
      { question: "La pierre remplace-t-elle un accompagnement ?", answer: "Non. Elle ne remplace jamais un avis médical, psychologique ou professionnel." }
    ]
  },
  {
    ...
    title: "Pierres pour l'argent et l'abondance : clarté, confiance et action",
    seoTitle: "Pierre pour argent et abondance : pyrite, citrine et œil de tigre",
    seoDescription: "Pierres traditionnellement associées à l'abondance symbolique, à la confiance et à l'action responsable.",
    ...
    emotionalPromise: "Le bracelet devient un rappel : organiser son énergie, faire un choix concret et avancer avec discernement.",
    ...
    giftAngle: "La pyrite ou l'œil de tigre conviennent bien à une personne qui lance un projet.",
    solutionSteps: ["Choisir une pierre dorée ou solaire.", "La relier à une action réaliste.", "Éviter toute promesse de résultat financier."],
    faq: [
      { question: "Quelle pierre est associée à l'abondance ?", answer: "La pyrite et la citrine sont traditionnellement associées à l'abondance symbolique." },
      { question: "Quelle pierre pour un projet professionnel ?", answer: "L'œil de tigre et la pyrite symbolisent confiance, structure et action." },
      { question: "Est-ce que cela attire l'argent ?", answer: "Le site ne promet aucun résultat. Il s'agit d'un support symbolique d'intention." },
      { question: "Comment porter la pyrite ?", answer: "En bracelet ou près du bureau, comme rappel d'organisation et de clarté." }
    ]
  },
  {
    slug: "creativite",
